...
window.addEventListener("scroll", ()=>{
    ...
    if(window.scrollY > 0){
        ...
        navMid.style = `top: 0; 
                        ...
                        padding-top: 10px;
                        padding-bottom: 10px`;
        sideBar.style = `top: 82px !important`
        // side categoy nav
...
const allBtn = document.querySelectorAll(".nav-mid .delivery .modal-body .btn-row .col-4 p");
...
$(document).ready(function(){
    $('.wrapper .content-wrapper .card .detail-img .sm-img').click(function(){
        ...
        $('.wrapper .content-wrapper .card .detail-img .big-img').attr('src', smallImages);
    });
});
...
// back btn
const backBtn1 = document.getElementById('back-1');
...
checkoutBtn.addEventListener('click', ()=>{
    ...
    cartPlaceOrder.style = `display: block`
...
// counter range for product-details page
