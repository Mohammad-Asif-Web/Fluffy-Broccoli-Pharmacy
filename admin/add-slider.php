...
if(isset($_POST['add-slider'])){
    ...
    $path = "dist/img/slider/".$file;

    move_uploaded_file($temp_name, $path);
    $sql = "INSERT INTO ecm_slider(slider_title, slider_image, date) VALUES(:title, :image, :date)";
                    ...
                    <div class="card card-dark">
                        <div class="card-header py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="fs-17 font-weight-600 mb-0">Add New Slider</h6>
                                </div>
                                <div class="text-right">
                                    <a href="slider-list.php" class="btn btn-secondary btn-sm mr-1"><img src="dist/img/icon/slider.png" class="mr-2" alt="" style="width: 20px;">Slider List</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="<?php $_SERVER['PHP_SELF']?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="d-flex flex-column">
                                ...
                                <button class="btn btn-info" name="add-slider" style="width: 100px">Add Image</button>
                            </form>
                        </div>
                    </div>
                </div>
